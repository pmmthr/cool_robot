...
class Mapping:
    ...
    def update_with_scan(self, pose, theta, z_max, walls, landmarks, n_beams=8):
        ...
        #     if math.hypot(dx, dy) < (self.resolution * 0.25) and dtheta < math.radians(2):
    ...
    def draw(self, screen):
        for r in range(self.rows):
            for c in range(self.cols):               
                ...
                # we check if l is positive or negative. Otherwise math range error
                if l >= 0:
                ...
                pygame.draw.rect(screen, (gray,)*3, rect)
